...
var BaseService = /** @class */ (function () {
     ...
     */
    function BaseService(merchantId, paymentKey, payoutKey, baseUrl) {
     ...
     * ```
     */
    BaseService.prototype.generateSign = function (payload, isPayment, jsonUnescape) {
        if (isPayment === void 0) { isPayment = true; }
        if (jsonUnescape === void 0) { jsonUnescape = false; }
        var encodedBody = Buffer.from(jsonUnescape
            ? JSON.stringify(payload).replace(/\\/g, "/")
            : JSON.stringify(payload)).toString("base64");
        var key = isPayment ? this.paymentKey : this.payoutKey;
     ...
     * ```
     */
    BaseService.prototype.request = function (endpoint_1, method_1, payload_1) {
        return __awaiter(this, arguments, void 0, function (endpoint, method, payload, isPayment) {
            var body, headers, response, data_1, data, errorMessages;
            if (isPayment === void 0) { isPayment = true; }
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (!(response.status === 422)) return [3 /*break*/, 3];
                        ...
                        if (data.state === 1) {
                            if ("errors" in data) {
                                errorMessages = Object.entries(data.errors)
                                    ...
                                    return "".concat(field, ": ").concat(msgs.join(", "));
                                })
                                    .join("; ");
